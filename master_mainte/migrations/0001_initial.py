    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete_flg', models.BooleanField(db_column='delete_flg', default=0, verbose_name='削除フラグ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_no', models.CharField(blank=True, db_column='staff_no', max_length=6, null=True, verbose_name='社員番号')),
                ...
                ('image_filename', models.FileField(db_column='image_filename', upload_to='uploads/', verbose_name='顔写真パス')),
                ...
                ('upd_id', models.CharField(blank=True, db_column='upd_id', editable=False, max_length=6, null=True, verbose_name='更新者')),
                ('upd_cnt', models.IntegerField(db_column='upd_cnt', default=0, editable=False, verbose_name='更新回数')),
                ('authuser_id', models.ForeignKey(db_column='authuser_id', on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='NSYSユーザーID')),
